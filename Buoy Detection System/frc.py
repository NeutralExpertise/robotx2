            ...
            if len(binVal) > 25:
                ...
                for target in self.targets:
                    if (deviceType == target[0] and manufacturerCode == target[1]):
                        ...
                        if (deviceType == 10 and deviceID == 5 and apiClass == 1):
                            print("Shooter data")
                            self.shooter.setCANStatus(apiIndex)

                        if (deviceType == 10 and deviceID == 6 and apiClass == 1):
                            print("Gate data")
                            self.gate.setCANStatus(apiIndex)

                        if (deviceType == 10 and deviceID == 6 and apiClass == 2):
                            print("Gate data")
                            self.gate.setGate(apiIndex)
...
class ShooterCan:
    ...
    def getColorData(self, c1, c2, c3):
        data = [c1,c2,c3]
        return data
...
class GateCan:
    ...
    def setGate(self, apiIndex):
        self.gateNumber = apiIndex
...
class MoveCan:
    ...
    def generateCANData(self, xVal, yVal, rVal, pVal):
        tempX = int(round(xVal * 1000)) + 2000
        tempY = int(round(yVal * 1000)) + 2000
        tempR = int(round(rVal * 1000)) + 2000
        tempP = int(round(pVal * 1000)) + 2000
